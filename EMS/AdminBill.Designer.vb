...
Partial Class AdminBill
    ...
    Private Sub InitializeComponent()
        ...
        Label15 = New Label()
        Bills = New DataGridView()
        txt_search = New TextBox()
        btn_paid = New Button()
        btn_unpaid = New Button()
        Label9 = New Label()
        btn_partial = New Button()
        Panel2.SuspendLayout()
        CType(PictureBox1, ComponentModel.ISupportInitialize).BeginInit()
        CType(Bills, ComponentModel.ISupportInitialize).BeginInit()
        SuspendLayout()
        ' 
        ' Panel2
        ' 
        ...
        ' Bills
        ' 
        Bills.ColumnHeadersHeightSizeMode = DataGridViewColumnHeadersHeightSizeMode.AutoSize
        Bills.Location = New Point(251, 271)
        Bills.Name = "Bills"
        Bills.RowHeadersWidth = 51
        Bills.Size = New Size(1455, 423)
        Bills.TabIndex = 5
        ' 
        ' txt_search
        ' 
        ...
        ' btn_paid
        ' 
        btn_paid.BackColor = Color.Yellow
        btn_paid.ForeColor = Color.Black
        btn_paid.Location = New Point(1403, 229)
        btn_paid.Name = "btn_paid"
        btn_paid.Size = New Size(141, 33)
        btn_paid.TabIndex = 8
        btn_paid.Text = "PAID"
        btn_paid.UseVisualStyleBackColor = False
        ' 
        ' btn_unpaid
        ' 
        btn_unpaid.BackColor = Color.Red
        btn_unpaid.ForeColor = Color.Transparent
        btn_unpaid.Location = New Point(1562, 230)
        btn_unpaid.Name = "btn_unpaid"
        btn_unpaid.Size = New Size(144, 33)
        btn_unpaid.TabIndex = 9
        btn_unpaid.Text = "UNPAID"
        btn_unpaid.UseVisualStyleBackColor = False
        ' 
        ' Label9
        ' 
        ...
        Label9.TabIndex = 10
        Label9.Text = "MANAGE BILL"
        ' 
        ' btn_partial
        ' 
        btn_partial.BackColor = Color.DeepSkyBlue
        btn_partial.ForeColor = Color.White
        btn_partial.Location = New Point(1238, 229)
        btn_partial.Name = "btn_partial"
        btn_partial.Size = New Size(141, 33)
        btn_partial.TabIndex = 11
        btn_partial.Text = "PARTIAL"
        btn_partial.UseVisualStyleBackColor = False
        ' 
        ' AdminBill
        ' 
        ...
        CType(Bills, ComponentModel.ISupportInitialize).EndInit()
        ResumeLayout(False)
        PerformLayout()
    End Sub
    Friend WithEvents btn_partial As Button
    ...
    Friend WithEvents Bills As DataGridView
    Friend WithEvents Label15 As Label
    Friend WithEvents txt_search As TextBox
    Friend WithEvents Button1 As Button
    Friend WithEvents btn_paid As Button
    Friend WithEvents btn_unpaid As Button
