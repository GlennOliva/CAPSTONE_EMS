...
Partial Class AdminStaff
    ...
    Private Sub InitializeComponent()
        ...
        Button1.TabIndex = 7
        Button1.Text = "CREATE STAFF"
        Button1.UseVisualStyleBackColor = False
        ' 
        ' btn_editstaff
        ' 
        btn_editstaff.BackColor = Color.Yellow
        btn_editstaff.ForeColor = Color.Black
        btn_editstaff.Location = New Point(1403, 229)
        btn_editstaff.Name = "btn_editstaff"
        btn_editstaff.Size = New Size(141, 33)
        btn_editstaff.TabIndex = 8
        btn_editstaff.Text = "EDIT STAFF"
        btn_editstaff.UseVisualStyleBackColor = False
        ' 
        ' btn_delete_staff
        ' 
        btn_delete_staff.BackColor = Color.Red
        btn_delete_staff.ForeColor = Color.Transparent
        btn_delete_staff.Location = New Point(1562, 230)
        btn_delete_staff.Name = "btn_delete_staff"
        btn_delete_staff.Size = New Size(144, 33)
        btn_delete_staff.TabIndex = 9
        btn_delete_staff.Text = "DELETE STAFF"
        btn_delete_staff.UseVisualStyleBackColor = False
        ' 
        ' Label9
        ' 
