...
Public Class AdminStudent
    ...
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        ...
        Dim studentModal As New AdminCreateStudentModal()
    ...
    Private Sub Button2_Click(sender As Object, e As EventArgs) Handles Button2.Click
        ...
        ' Open the edit modal
        Dim editForm As New AdminEditStudentModal()
    ...
    Private Sub AdminStudent_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        LoadStudentsData()
    End Sub
