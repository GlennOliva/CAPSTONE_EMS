...
Partial Class AdminReports
    ...
    Private Sub InitializeComponent()
        ...
        Label15 = New Label()
        Reports = New DataGridView()
        txt_search = New TextBox()
        Label9 = New Label()
        btn_export = New Button()
        Panel2.SuspendLayout()
        CType(PictureBox1, ComponentModel.ISupportInitialize).BeginInit()
        CType(Reports, ComponentModel.ISupportInitialize).BeginInit()
        SuspendLayout()
        ' 
        ' Panel2
        ' 
        ...
        Reports.Location = New Point(251, 271)
        Reports.Name = "Reports"
        Reports.RowHeadersWidth = 51
        Reports.Size = New Size(1455, 423)
        Reports.TabIndex = 5
        ' 
        ' txt_search
        ' 
        ...
        Label9.Name = "Label9"
        Label9.Size = New Size(377, 46)
        Label9.TabIndex = 10
        Label9.Text = "MANAGE REPORTS"
        ' 
        ' btn_export
        ' 
        btn_export.BackColor = Color.MediumSeaGreen
        btn_export.ForeColor = Color.White
        btn_export.Location = New Point(1556, 221)
        btn_export.Name = "btn_export"
        btn_export.Size = New Size(150, 35)
        btn_export.TabIndex = 0
        btn_export.Text = "EXPORT TO PDF"
        ...
        CType(Reports, ComponentModel.ISupportInitialize).EndInit()
        ResumeLayout(False)
        PerformLayout()
    End Sub
    ...
    Friend WithEvents Reports As DataGridView
