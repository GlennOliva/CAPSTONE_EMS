...
Partial Class AdminEditStaffModal
    ...
    Private Sub InitializeComponent()
        ...
        Label9.Name = "Label9"
        Label9.Size = New Size(233, 46)
        Label9.TabIndex = 10
        Label9.Text = "EDIT STAFF"
        ' 
        ' txt_lastname
        ' 
        ...
        btn_create_staff.Text = "EDIT STAFF"
        ...
        MaximizeBox = False
        Name = "AdminEditStaffModal"
        StartPosition = FormStartPosition.CenterScreen
        Text = "AdminEditStaffModal"
